      ...
      <div className="container">
        <div data-aos="fade" className="about__card">
          ...
          <div className="about__content">
            <div data-aos="fade-left" className="about--title heading--secondary">
              about me
            </div>
            <div data-aos="fade-left" className="about--paragraph paragraph--small">
              I’m a Self-motivated Web Developer with
              experience of working on multiple projects. Passionate, hardworking
              and open to opportunities. I have been exploring the web
              technologies since 4+ years now.
            </div>
            <div className="about__list">
              <div data-aos="fade-left" className="about__list--item">
                ...
                <div className="about__list--text paragraph--small">Muhammad Ilyas</div>
              </div>
              <div data-aos="fade-left" className="about__list--item">
                <svg
                  className="about__list--icon"
            ...
            <div data-aos="fade-left" className="about__interests">Interests</div>
